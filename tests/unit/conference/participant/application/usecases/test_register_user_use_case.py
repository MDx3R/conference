...
class TestRegisterUserUseCase:
    ...
    def setup(self):
        ...
        self.user_factory = Mock(spec=IParticipantFactory)
        self.user_factory.create.return_value = self.participant

        self.user_repository = Mock(spec=IParticipantRepository)
    ...
    async def test_register_success(self):
        ...
        self.user_repository.add.assert_awaited_once_with(self.participant)
