...
class TestParticipant:
    ...
    def test_create_success(self):
        ...
        assert participant.full_name.surname == "Иванов"
        assert participant.phone_number.value == "+79998887766"
        assert participant.address.city == "Москва"
        assert participant.about.academic_degree == AcademicDegree.CANDIDATE
