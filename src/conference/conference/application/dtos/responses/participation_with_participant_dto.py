...
class ParticipationWithParticipantDTO:
    conference_id: UUID
    participant_id: UUID
    ...
    @classmethod
    def from_read_model(
        cls, participation: ParticipationWithParticipantReadModel
    ) -> Self:
        return cls(
            ...
            participant_patronymic=participation.participant_patronymic,
            participant_city=participation.participant_city,
    ...
    def full_name(self) -> str:
        if self.participant_patronymic:
            return f"{self.participant_surname} {self.participant_name} {self.participant_patronymic}"
        return f"{self.participant_surname} {self.participant_name}"
